package id.ac.poliban.mi.priam024.notificationschedulercc_083;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar()!=null)getSupportActionBar().setTitle("Notification Scheduler_024 PRIMA-E020320024");
